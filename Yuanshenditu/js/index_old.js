...
function onEachFeature(feature, layer) {
  ...
  popupHtml +=
    '<div class="myPopComment"><span>' +
    feature.properties.popupContent +
    '</span><img class="Select" src=imgs/con_img/Select.png></div>'
  popupHtml += '<div class="myPopPicture">'
  popupHtml +=
    '<img src=comment_png/' +
    key +
    ".jpg onerror=\"javascript:$('.myPopComment,.myPopPicture').addClass('disable');$('.myPopComment').css({'cursor': 'default'})\">"
  popupHtml += '</div>'
  popupHtml +=
    '<div class="' +
    switchClass +
    ...
    key +
    '"><p class="switchOff">未完成</p><p class="switchOn">已完成</p><div class="switchButton"><div class="switchButtonIcon"><p>未完成</p></div></div></div>'
...
map.on('popupopen', function (e) {
  ...
  popupHtml += '<div class="myPopClose" onclick="closePop()"></div>'
  popupHtml +=
    '<div class="myPopComment" onclick="change()"><span>' +
  ...
  popupHtml +=
    ...
    '" onclick="MarkPoint(this)" data-key="' +
    key +
    '"><p class="switchOff">未完成</p><p class="switchOn">已完成</p><div class="switchButton"><div class="switchButtonIcon"><p>' +
    switchText +
    '</p></div></div></div>'
  popupHtml += '<div class="tipcard"></div>'
  popupHtml += '</div>'
